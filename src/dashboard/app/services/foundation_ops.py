...
def _daily_completeness_operator_text(item: dict, day: str, language_profile: str) -> dict:
    ...
    if is_english_profile(language_profile):
        labels = {
            ...
            "diary-skill": "Skill Pass assets",
            "diary-environment": "encrypted environment assets",
        ...
        actions = {
            ...
            "diary-skill": "Run Skill Pass or historical backfill for this date.",
            "diary-environment": "Run the Technical Pass or historical backfill for this date.",
    ...
    actions = {
        ...
        "diary-skill": "运行 Skill Pass，或使用历史数据补全让系统补跑该日期。",
        "diary-environment": "运行 Technical Pass，或使用历史数据补全让系统补跑该日期。",
