...
class RuntimeSettingsTests(unittest.TestCase):
    ...
    def test_nova_settings_status_reports_readonly_doctor_payload(self):
        ...
        self.assertIn("Nova settings status:", text)
        self.assertIn("Pipeline:", text)
        self.assertIn("Dashboard:", text)
        self.assertIn("Runtime source:", text)
        self.assertIn('"languageProfile"', raw_json)
        self.assertNotIn("任务看板", text)
        self.assertNotIn("设置", text)
        self.assertIn("Resource profile:", text)
        self.assertIn("Dependencies:", text)
        self.assertIn("Settings audit:", text)
    ...
    def test_nova_settings_status_supports_layered_doctor_profiles(self):
        ...
        self.assertIn("Nova doctor (pipeline):", pipeline_text)
    ...
    def test_nova_settings_status_recommends_source_only_sync_for_stale_runtime_source(self):
        ...
        self.assertNotIn(str(source_root), json.dumps(runtime_source))
        self.assertIn("Runtime source action: Sync runtime source snapshot only:", text)
        self.assertNotIn(str(source_root), text)
        by_id = {item["id"]: item for item in payload["checks"]}
    ...
    def test_nova_onboarding_status_aggregates_readonly_new_user_payload(self):
        ...
        self.assertIn("Nova onboarding status:", text)
        self.assertIn("Requirement sets:", text)
    ...
    def test_onboarding_subsystem_plan_is_readonly_and_profile_selectable(self):
        ...
        self.assertTrue(groups["dashboard"]["selected"])
        self.assertIn("Nova onboarding plan:", text)
        self.assertIn("Selected profiles:", text)
    ...
    def test_onboarding_one_liner_dry_run_reports_v1_apply_contract(self):
        ...
        self.assertIn("Nova onboarding runtime dry-run:", text)
        self.assertIn("Command draft:", text)
        self.assertIn('"selectedProfiles"', raw_json)
        ...
        self.assertIn("Requirement sets", format_onboarding_subsystem_plan(payload["sourcePlan"]))
        self.assertIn("packagingGroups=", text)
        self.assertIn("Nova onboarding runtime dry-run:", text)
