#!/usr/bin/env python3
"""Print read-only Actanara settings status for onboarding and operator checks."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--runtime", help="Inspect a candidate ACTANARA_HOME without selecting it.")
